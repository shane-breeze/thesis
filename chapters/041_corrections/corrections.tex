...
parameteric), background model, MC generator (LO against NLO), and additional
...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption{
        \Ptauh identification scale-factors parameterised by the \Ptauh \pt. The dashed line 
    }
